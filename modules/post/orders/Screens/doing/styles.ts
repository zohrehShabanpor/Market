...
import { CircleCheck as circleCheck, CircleDots as circleDots } from "@images";
...
export const CircleCheck = styled(circleCheck)`
  & path {
...
export const CircleDots = styled(circleDots)`
  & path {
    :nth-of-type(2) {
      fill: ${theme.palette.blueDeFrance[90]}!important;
    }
